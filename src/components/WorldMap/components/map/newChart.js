...
const csvfile = require("./skillsdata.csv");

class NewChart extends React.Component {
	constructor(props) {
		super(props);
		this.creatNewChart = this.creatNewChart.bind(this);
	}

	creatNewChart() {

		var svg = d3.select("svg#hello"),
        ...
        leafNodeG.append("rect")
                ...
                .transition()
                    .duration(800)
                    .attr("width", function (d) {return xScale(d.data.score);});
        ...
        function handleMouseOver(d) {
            ...
            ballGMovement.select("text")
                    .delay(300)
                    .text(Number(d.data.score).toFixed(1));
        }
	...
	render() {
		return (
			<button className="haha" onClick={this.creatNewChart}>Click Me</button>
		);
	}
}
